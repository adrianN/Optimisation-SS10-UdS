...
We introduce variables $z_1,z_2,\ldots , z_t$, $t = \sum_{di}$ s.t. 
...
\begin{Def}[Cutting pattern] A cutting pattern is a set of numbers $(a_1,\ldots,a_k)$ s.t. $a_i\in \N$ and $\sum a_il_i\leq L$ and the sum is maximal.
\end{Def}
