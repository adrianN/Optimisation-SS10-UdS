...
%\item[$P\subseteq$CH(ex. points of $P$)]
%\end{description}
\end{pr}

\begin{cor}\label{Cor:always_extreme_point} Let $P$ be a non-empty bounded polyhedron. Thet the LP $\min cx$ s.t. $x\in P$ has a optimal solution that is an extreme point of $P$.
\end{cor}
