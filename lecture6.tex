...
It has to be the case that all the remaining variables have value 0. I think this is because otherwise the objective value would change in each iteration and we would have to terminate after some time. %right?
